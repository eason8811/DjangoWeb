...
def fig_output_html():
    ...
    (
        ...
        .render("Emotional_Analysis/templates/graphic/daily_comment_line.html")
    )
    ...
    (
        ...
        .render("Emotional_Analysis/templates/graphic/daily_horizon.html")
    )

    word_comment = pd.read_csv("Emotional_Analysis/output/words_day.csv", index_col=0)
    ...
    (
        ...
        .render("Emotional_Analysis/templates/graphic/all_comment.html")
    )
...
def fig_kline(code, day):
    ...
    c = (
        ...
        .render(f"Emotional_Analysis/templates/graphic/kline_{code}.html")
    )
...
def liquid():
    ...
    grid.render("Emotional_Analysis/templates/graphic/main_liquid.html")
...
def fig_pie():
    ...
    (
        ...
        .render("Emotional_Analysis/templates/graphic/pie_.html")
    )
...
def fig_calendar():
    ...
    c = (
        ...
        .render("Emotional_Analysis/templates/graphic/calendar.html")
    )
